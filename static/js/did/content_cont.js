...
$(function() {
   ...
   $('#mn_content').attr({
    ...
    if($("#current_user_grade").val() == '0101'){
        window.location.href = '/content/admin/cont?workspace_id='+now_workspaceID+'&workspace_nm='+workspace_nm;
    }
    ...
    $("#btn_point").click(function(){
        ...
        setTimeout(() => {
            ...
            for(var i =0; i< result_list.file_name.length; i++){
                var file_data = result_list.file_name[i]
                var tiff_name = result_list.file_name[i].file_name;
                var flie_path = result_list.file_name[i].file_path;
                var nas_path = flie_path.split('ECTNFS_CHANGE')[1];
