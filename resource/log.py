...
class LogMessage:
    ...
    str_format = {
        ...
        "msg_point": "USER-ID: {user_id}, USER-NM: {user_nm} 님이 포인트 {message} 하였습니다.",
        "msg_payment": "USER-ID: {user_id}, USER-NM: {user_nm} 님이 {message} 하였습니다.",
    ...
    def set_message(key, message, menu):
        ...
        try:
            ...
            log_obj = LogModel( msg, menu, user_id, create_date)
            log_obj.save_to_db()
